...
output "jenkins_message" {
  value = "Information on your Jenkins install is contained in ${var.build_project}-jenkins.txt"
}
...
output "backstage_message" {
  value = "Information on your Backstage install is contained in ${var.build_project}-backstage.txt"
}
